      ...
      extraApps = {
        inherit (config.services.nextcloud.package.packages.apps) 
          ...
          cospend = pkgs.fetchNextcloudApp rec {
            ...
            license = "agpl3";
            sha256 = "sha256-adf6e6971899d2c43189d159ebcfe2705cc798ba18c4b0261f6d0d7a38f51eff";
          deck 
          drawio = pkgs.fetchNextcloudApp rec {
            url =
              "https://github.com/jgraph/drawio-nextcloud/releases/download/v3.1.0/drawio-v3.1.0.tar.gz";
            license = "agpl3";
            sha256 = "sha256-8f19b4ed7fb98bb49bc5f303ac638b3241789927862e661ea5202f44e76f2701";        
          news
          notes
          phonetrack = pkgs.fetchNextcloudApp rec {
            ...
            license = "agpl3";
            sha256 = "sha256-7c4252186e0ff8e0b97fc3d30131eeadd51bd2f9cc6aa321eb0c1c541f9572c0";
          tasks 
          twofactor_admin = pkgs.fetchNextcloudApp rec {
            ...
            license = "agpl3";
            sha256 = "sha256-cd9bc7ef17d2a282811b808abd2b9ff03ffa2a7284ba72daf8344b024586a28c";
          twofactor_webauthn;
      };
